...
for (i, n) in enumerate(r)
    ...
    differences1[i] = 1/num_valid * norm(lt[valid] .- baseline[valid]);
...
ax1 = Axis(fig[1, 1], xlabel=L"n", ylabel="Mean Squared Error", yscale=log10, xscale=log10);
