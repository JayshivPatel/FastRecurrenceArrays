...
lt = @lift logtransform($n);
g = @lift gaussquadrature($n);

ax1 = Axis(fig[1, 1], xlabel=L"z", ylabel="Baseline");
ax2 = Axis(fig[2, 1], xlabel=L"z", ylabel="FastGaussQuadrature");
ax3 = Axis(fig[3, 1], xlabel=L"z", ylabel="FastRecurrenceArrays");
